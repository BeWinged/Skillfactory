...
# TC-SF-006: Валидация поля "E-mail или мобильный телефон" в форме Регистрации". Маска Email
...
# TC-SF-016: Открытие документа "Пользовательское соглашение"
...
def test_docs_privacy():
	enter_to_registration()
	# Шаг 1
	pytest.driver.find_element(By.XPATH, '//*[@id="rt-footer-agreement-link"]/span[0]').click()
...
# TC-SF-019: Повторный запрос кода
...
# TC-SF-020: Изменение Email после отправки кода
...
# TC-SF-021: Окно с описанием Cookie
