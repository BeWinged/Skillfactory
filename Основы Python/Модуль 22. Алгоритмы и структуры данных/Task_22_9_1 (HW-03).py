while True:
	try:
		...
		if (user_number_index == 0):
			...
			print('Номер позиции ближайшего элемента (' + str(subsequence[user_number_index - 1]) + '), который меньше введенного пользователем числа: '
				  + str(user_number_index - 1))
			print('Номер позиции ближайшего элемента (' + str(subsequence[user_number_index + 1]) + '), который больше введенного пользователем числа: '
				  + str(user_number_index + 1))
		break
